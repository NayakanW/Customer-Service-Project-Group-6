 ...
 * Model Ticket
 * 
 * Model ini merepresentasikan tiket dalam sistem customer service.
 * 
 * Fitur:
 * 1. Manajemen tiket customer service
 * 2. Status dan prioritas tiket
 * 3. Penugasan tiket ke tim/agent
 * 4. Riwayat perubahan tiket
 * 5. Kategorisasi dan tagging tiket
 */
class Ticket extends BaseModel
{
    ...
    public function updateStatus($status)
    {
        ...
        if ($status == Ticket::STATUS_SOLVED && ! $this->rating && config('helpdesk.sendRatingEmail')) {
