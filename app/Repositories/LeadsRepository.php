 ...
 * 
 * Repository ini menangani operasi database untuk leads (prospek).
 * 
 * Fitur:
 * 1. Query dan filter leads
 * 2. Statistik dan laporan leads
 * 3. Pengambilan data leads berdasarkan kriteria
 * 4. Manajemen status leads
 * 5. Penugasan dan tracking leads
 */
