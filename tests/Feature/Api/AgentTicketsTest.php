...
class AgentTicketsTest extends TestCase
{
    ...
    {
        factory(User::class)->create(['email' => 'admin@helpdesk.io', 'password' => bcrypt('the-password'), 'token' => 'agent-token', 'admin' => true]);

        $response = $this->post("api/agent/login", ["email" => 'admin@helpdesk.io', 'password' => 'the-password']);
